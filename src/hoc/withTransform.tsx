        ...
        <Transformer
          ...
          onTransformEnd={(e) => {
            ...
            if (props.type === 'text') {
              ...
              const currentFontSize = textNode.fontSize() || 40;
              textNode.scaleX(1);
              textNode.scaleY(1);
              handleInfo({
                ...handleKonvaItem(textNode),
                fontSize: Math.round(currentFontSize * scaleY),
                scaleX: 1,
                scaleY: 1,
              });
            } else {
              handleInfo(handleKonvaItem(node));
            }
          }}
        />
      </>
